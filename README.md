...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3474_passing-427819?style=for-the-badge" alt="3474 tests passing"/>
</p>
...
Twenty five environments, forty three agents, a gradient engine, a dynamic
...
rel/envs/               twenty five environments. Never import an agent.
rel/agents/             forty three agents. Never import an environment.
  ...
  fourier.py            cosine waves over a box, whose only setting is an order
  ...
  gaussian.py           a policy over a box: where to aim and how wide
...
Not counting 27913 lines of tests and 8747 of measurement scripts. The command
...
3474 tests. Some of what they cover, and why each one is there rather than the
obvious alternative:
...
- [Writing a grid](docs/grids.md) - a new environment as a text file, with no
  Python in it
...
Alpha, and complete enough to be useful. Twenty five environments and forty three
...
measurement runs for four hundred. On the pendulum both of the agents that
learn a policy directly are behind a policy that draws at random, while the
ones that keep a value and rank it learn it. All of it is measured
